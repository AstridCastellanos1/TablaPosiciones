...
namespace CalcularTablaPosicionesC
{
    public sealed class Program
    {
        ...
        static readonly int FILAS = 12;
        static readonly int COLUMNAS = 10;
        ...
        public static void ordenPorPuntos()
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                for (int j = 0; j < 12 - i - 1; j++)
                {
                    ...
                    a = Int16.Parse(tabla[j,Col.PUNTOS]);
                    b = Int16.Parse(tabla[j + 1,Col.PUNTOS]);
        ...
        public static void llenarTabla()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    int golesFavor = Int16.Parse(tabla[i, Col.GOLES_FAVOR]);
                    int golesContra = Int16.Parse(tabla[i, Col.GOLES_CONTRA]);

                    int diferenciaGoles = golesFavor - golesContra;

                    tabla[i, Col.GOLES_DIFERENCIA] = Convert.ToString(diferenciaGoles);
                }
                        ...
                        && tabla[i, Col.PERDIDOS] != null)
                {
                    ...
                    int ptsGanados = Int16.Parse(tabla[i, Col.GANADOS]) * 3;
                    int ptsEmpates = Int16.Parse(tabla[i, Col.EMPATES]);

                    tabla[i, Col.PUNTOS] = Convert.ToString(ptsGanados + ptsEmpates);
